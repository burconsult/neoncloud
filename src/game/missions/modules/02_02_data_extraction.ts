...
export const dataExtractionMissionModule: MissionModule = {
  ...
  mission: {
    ...
    tasks: [
      ...
      {
        id: 'task-6',
        description: getTaskDescription('n00b-02', 'Extract customer-data.txt'),
        type: 'command',
        objective: getTaskObjective('n00b-02', 'Read customer-data.txt from /home/admin/database/customers/'),
        hints: getTaskHints('n00b-02', [
      ...
      {
        id: 'task-7',
        description: getTaskDescription('n00b-02', 'Extract financial-report.txt'),
        type: 'command',
        objective: getTaskObjective('n00b-02', 'Read financial-report.txt from /home/admin/database/reports/'),
        hints: getTaskHints('n00b-02', [
